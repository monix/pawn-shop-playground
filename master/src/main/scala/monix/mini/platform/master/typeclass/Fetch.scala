...
import monix.mini.platform.master.WorkerRef
...
object Fetch {
  ...
  implicit val allFetch = new Fetch[FetchAllReply, FetchAllReplyView] {
    ...
    override val send = (slaveRef: WorkerRef, fetchRequest: FetchRequest) => slaveRef.stub.fetchAll(fetchRequest)
  ...
  implicit val transactionsFetch = new Fetch[FetchTransactionsReply, FetchTransactionsReplyView] {
    ...
    override val send = (slaveRef: WorkerRef, fetchRequest: FetchRequest) =>
